public class Pond {
 public static void main(String[] args ){
     ...
     // setter usage
     riri.setAge(9);
     System.out.println("3. new he si " + String.valueOf(riri.getAge()));
     ...
     System.out.println("5: Now his swimming stat is : " + String.valueOf(fifi.isSwimming()));
     ...
     // static method
     System.out.println("7 What this duck says :" + Duck.quack());

     //two references to the same object
     Duck mysterMask = new Duck("Myster Mask");
     Duck albertColvert = mysterMask;

     // bot aim at ehe same memory space
